        ...
        $(function () {
            ...
            $('#dataList').datagrid({
                ...
                columns: [[
                    ...
                    {field: 'clazz_name', title: '机会来源', width: 150},
                    {field: 'clazz_name', title: '客户名称', width: 150},
                    {field: 'clazz_name', title: '成功机率', width: 150},
                    {field: 'name', title: '概要', width: 150},
                    {field: 'tno', title: '联系人', width: 150},
                    {field: 'gender', title: '联系人电话', width: 50},
                    {field: 'email', title: '机会描述', width: 150},
                    {field: 'telephone', title: '创建人', width: 150},
                    {field: 'address', title: '创建时间', width: 150}
                    {field: 'address', title: '指派给', width: 150}
                    {field: 'address', title: '指派时间', width: 150}
                ]],
                toolbar: "#toolbar"//工具栏
            });
